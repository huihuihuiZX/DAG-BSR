...
# Data specifications
parser.add_argument('--data_dir', type=str, default='/DiskA/dataset/',
...
parser.add_argument('--patch_cut', type=bool, default=True,
                    help='image repeat in dataloader')
parser.add_argument('--patch_cut_two', type=bool, default=True,
...
parser.add_argument('--down_sample_prob', type=list, default=[0, 0, 0, 1],
                    help='')
parser.add_argument('--noise_list', type=list, default=['uniform_noise', 'gaussian_noise', 'poisson_noise'],
                    help='')
parser.add_argument('--noise_prob', type=list, default=[0, 1, 0],
                    help='')
...
parser.add_argument('--noise_max', type=float, default=10.0,
                    help='noise level range')
parser.add_argument('--std_min', type=float, default=0.2,
                    help='')
parser.add_argument('--std_max', type=float, default=2.0,
                    help='')
parser.add_argument('--lambda_min', type=float, default=0.5,
                    help='')
parser.add_argument('--lambda_max', type=float, default=1.5,
                    help='')
parser.add_argument('--jpeg_min', type=float, default=95,
                    help='')
parser.add_argument('--jpeg_max', type=float, default=95,
                    help='')
...
parser.add_argument('--project_path', type=str, default='/home/xzh/code/BSRGNN',
                    help='project path')
parser.add_argument('--resume', type=bool, default=True,
                    help='resume from specific checkpoint')
parser.add_argument('--resume_path', type=str, default='',
                    help='resume path')#/home/xzh/code/BSRGNN/experiment/aniso_64_90_0.01/model/model_0293.pth.tar
parser.add_argument('--test_every', type=int, default=1000,
                    help='do test per every N batches')
parser.add_argument('--epochs_dp', type=int, default=1 ,
...
parser.add_argument('--model_name', type=str, default='aniso1',
                    help='file name to save')
parser.add_argument('--save_models', action='store_true',
                    help='save all intermediate models')
parser.add_argument('--print_every', type=int, default=7000,
