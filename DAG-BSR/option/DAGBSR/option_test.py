...
# Data specifications
parser.add_argument('--data_dir', type=str, default='/DiskA/xzh/dataset/aniso',
...
parser.add_argument('--sigma_min', type=float, default=3.5,
                    help='')
...
parser.add_argument('--epochs_sr', type=int, default=400,
...
parser.add_argument('--model_name', type=str, default='ResBSRGNN_isoX2',
